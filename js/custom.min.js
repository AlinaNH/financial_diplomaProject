...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        /*if($("#mybarChart").length){var f=document.getElementById("mybarChart");new Chart(f,{type:"bar",data:{labels:["Alina","February","March","April","May","June","July"],datasets:[{label:"# Значение",backgroundColor:"#26B99A",data:[70,30,40,28,92,50,45]},{label:"# of Votes",backgroundColor:"#03586A",data:[72,56,25,48,72,34,12]}]},options:{scales:{yAxes:[{ticks:{beginAtZero:!0}}]}}})}*/
